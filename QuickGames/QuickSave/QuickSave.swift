...
class QuickSave: UIViewController {
...
fileprivate extension QuickSave {
  ...
  func getGameOverTitleAndMessage() -> (String, String) {
    ...
    case 0..<10: return ("Try again?", "The more you play, the better you get!")
    case 10..<30: return ("Try again?", "Better than before!")
    case 30..<60: return ("Try again?", "You've beaten Quick Inc.'s Founder!")
    case 60..<90: return ("Try again?", "Damn Legend!")
    default:
      return ("Try again?","")
    }
  }
